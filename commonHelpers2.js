...
<p class="shop-list-description">${a}<p>
<div class="shop-list-downpart">
<p class="shop-list-author"> Author: ${s}</p>
<div class="shop-list-links">
<a class="amazon-link" target="_blank" href="${A.find(r=>r.name==="Amazon").url}">
<img 
...
<a class="openbooks-link" target="_blank" href="${A.find(r=>r.name==="Apple Books").url}">
     <img 
...
</div>`}function w(t){if(t.target.classList.contains("remove-shop-list-book")||t.target.classList.contains("icon-basket-shop-list")||t.target.dataset.name==="remove-shop-list-book"){const o=t.target.getAttribute("data-bookid");F(o)}}function F(t){let o=localStorage.getItem("books");if(o){o=JSON.parse(o);const e=o.indexOf(t);e!==-1&&o.splice(e,1),localStorage.setItem("books",JSON.stringify(o)),f()}}document.addEventListener("click",w);function Z(){const t=document.querySelector(".navigation_link_shopping"),o=document.querySelector(".basket");t.classList.add("active"),o.classList.add("active")}Z();

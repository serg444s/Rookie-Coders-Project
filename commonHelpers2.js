...
</div>`}function F(t){if(t.target.classList.contains("remove-shop-list-book")||t.target.classList.contains("icon-basket-shop-list")||t.target.dataset.name==="remove-shop-list-book"){const o=t.target.getAttribute("data-bookid");Z(o)}}function Z(t){let o=localStorage.getItem("books");if(o){o=JSON.parse(o);const e=o.indexOf(t);e!==-1&&o.splice(e,1),localStorage.setItem("books",JSON.stringify(o)),f()}}document.addEventListener("click",F);function q(){document.querySelector(".navigation_link_shopping").classList.add("active")}q();

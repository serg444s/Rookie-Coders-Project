import{o as b,a as I,b as O,c as $}from"./assets/openbook-2238cf13.js";import{a as m,b as q}from"./assets/vendor-9b4a9007.js";async function u(t){return t.map(({author:o,book_image:e,title:a,description:n,_id:c})=>`<li class="books-item-about" >  
    <div class="book-wrap"> 
  ...
  <ul class='list-books'>${await p(o)}</ul>`}async function y(){const t="https://books-backend.p.goit.global/books/category-list";try{return(await m.get(t)).data}catch(o){console.error("Error fetching books:",o)}}async function C(){try{const t=await y(),o=document.querySelector(".categories-list_books");t.forEach(e=>{const a=document.createElement("li");a.classList.add("item-list_category"),a.dataset.category=e.list_name;const n=document.createElement("a");n.textContent=e.list_name,n.href=`#${e.list_name}`,n.classList.add("link_category-book"),a.appendChild(n),o.appendChild(a),a.addEventListener("click",async()=>{const c=a.dataset.category;await k(c)})})}catch(t){console.error("Error rendering categories:",t)}}document.addEventListener("DOMContentLoaded",C);const S=document.querySelector('[data-action="open-modal"]'),f=document.querySelector('[data-action="close-modal"]'),h=document.querySelector("body");function B(){document.body.classList.add("show-modal"),f.style.display="flex",S.style.display="none",h.style.overflow="hidden"}function P(){document.body.classList.remove("show-modal"),f.style.display="none",S.style.display="flex",h.style.overflow="auto"}let l=JSON.parse(localStorage.getItem("books"))||[];function D(t){l=JSON.parse(localStorage.getItem("books"))||[],l.includes(t)||(l.push(t),localStorage.setItem("books",JSON.stringify(l)))}function L(t){const o=JSON.parse(localStorage.getItem("books")),e=o.findIndex(a=>a===t);e!==-1&&o.splice(e,1),localStorage.setItem("books",JSON.stringify(o))}async function H(t){const o=`https://books-backend.p.goit.global/books/${t}`;return(await m.get(o)).data}const N=document.querySelector(".top-categories-list");document.querySelector(".modal-btn");document.querySelector(".modal-congrat-text");let r;N.addEventListener("click",w);let s;async function w(t){if(t.preventDefault(),t.target.nodeName!=="IMG")return;r=t.target.dataset.id;const o=await H(r);let e;l.includes(r)||(e="ADD TO SHOPPING LIST"),l.includes(r)&&(e="REMOVE FROM THE SHOPPING LIST");const{book_image:a,title:n,author:c,description:v,amazon_product_url:E}=o;s=q.create(`<div class="modal">
